...
import { BrushIcon, CircleIcon, EraserIcon, MinusIcon, MousePointerIcon, SquareIcon } from 'lucide-react';
import { useCallback } from 'react';
import { useDispatch, useSelector } from 'react-redux';

const TOOLS = [
	{ id: ACTIONS.POINTER, icon: <MousePointerIcon size={16} color={'var(--color)'} />, label: 'Курсор' },
