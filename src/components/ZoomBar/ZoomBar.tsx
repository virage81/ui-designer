	...
	return (
		<Paper
			...
			<Box sx={{ display: 'flex', alignItems: 'center', gap: 2, width: '35%' }}>
				<IconButton onClick={handleMinus} size='small' sx={{ color: 'var(--color)' }} title='Уменьшить слой ( - )'>
					<ZoomOut size={18} />
				</IconButton>
				...
				<IconButton onClick={handlePlus} size='small' sx={{ color: 'var(--color)' }} title='Увеличить слой ( + )'>
					<ZoomIn size={18} />
				</IconButton>
			</Box>
		</Paper>
